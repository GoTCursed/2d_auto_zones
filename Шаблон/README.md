...
Семейство прямой зоны выбирается **из текущего проекта Revit** (уже загруженное), без подгрузки `.rfa` из `families/`.  
По умолчанию ищется `SUM-30-Зона дополнительного армирования` / `_R22`.  
